...
struct MyRecipesView: View {
    ...
    @State private var recipes: [Recipe] = [
        Recipe(name: "Egg Fried Noodles", time: "20min", tools: "Microwave", imageName: "egg_fried_noodles"),
        Recipe(name: "Chicken Rice", time: "30min", tools: "Gas Cooker", imageName: "chicken_rice"),
        Recipe(name: "Quick Pasta", time: "15min", tools: "Gas Cooker", imageName: "quick_pasta"),
        Recipe(name: "Microwave Mug Cake", time: "5min", tools: "Microwave", imageName: "mug_cake")
    ]
